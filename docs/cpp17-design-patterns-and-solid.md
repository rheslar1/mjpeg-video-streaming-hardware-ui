...
```bash
./build/mjpeg_video_streaming_server_with_hardware_ui --nominal
./build/mjpeg_video_streaming_server_with_hardware_ui --unsafe
./build/mjpeg_video_streaming_server_with_hardware_ui --offline
```
