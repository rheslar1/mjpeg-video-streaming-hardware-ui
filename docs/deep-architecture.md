# MJPEG Video Streaming Server with Hardware UI Deep Architecture
...
C++17, C++ Design Patterns, SOLID, V4L2, MJPEG, HTTP server, CSI camera, GPIO buttons, Hardware UI
