...
| --- | --- | --- |
| FR-001 | Provide a deterministic host-buildable runtime for MJPEG Video Streaming Server with Hardware UI. | CMake/CTest or equivalent CI. |
| FR-002 | Implement the project focus: V4L2 camera project that captures snapshots, records raw video, streams MJPEG over a local HTTP server, and maps physical buttons into UI actions. | Scenario tests and documentation review. |
