# MJPEG Video Streaming Server with Hardware UI Requirements

## Functional Requirements

| ID | Requirement | Verification |
| --- | --- | --- |
| FR-001 | The system shall expose a deterministic host-buildable runtime for MJPEG Video Streaming Server with Hardware UI. | CMake/CTest smoke run. |
| FR-002 | The system shall model the project focus: V4L2 camera project that captures snapshots, records raw video, streams MJPEG over a local HTTP server, and maps physical buttons into UI actions. | Scenario tests and documentation review. |
